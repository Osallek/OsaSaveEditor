...
public class OsaSaveEditorUiApplication extends Application {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OsaSaveEditorUiApplication.class);
    ...
    public void init() {
        ...
        this.applicationContext = new SpringApplicationBuilder(OsaSaveEditorApplication.class)
