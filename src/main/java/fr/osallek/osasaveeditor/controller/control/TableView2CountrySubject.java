...
import fr.osallek.osasaveeditor.controller.converter.SubjectTypeStringConverter;
...
public class TableView2CountrySubject extends TableView<CountrySubject> {
    ...
    public TableView2CountrySubject(SaveCountry country, ObservableList<CountrySubject> countrySubjectsField, ObservableList<SaveCountry> countriesAlive,
        ...
        TableColumn<CountrySubject, SaveCountry> subject = new TableColumn<>(
                country.getSave().getGame().getLocalisationClean("LEDGER_SUBJECT", Eu4Language.getByLocale(Constants.LOCALE)));
        ...
        TableColumn<CountrySubject, SubjectType> type = new TableColumn<>(country.getSave()
                                                                                 .getGame()
                                                                                 .getLocalisationCleanNoPunctuation("LIBERTY_DESIRE_FROM_SUBJECT_TYPE", Eu4Language.getByLocale(Constants.LOCALE)));
