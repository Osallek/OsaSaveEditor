        ...
        if (force || this.country == null || !this.country.equals(country)) {
            ...
            if (this.country == null) {
                ...
                for (int i = 0; i < this.country.getSave().getInstitutions().getNbInstitutions(); i++) {
                    CheckBoxItem checkBoxItem = new CheckBoxItem(OsaSaveEditorUtils.localize("INSTITUTIONS", this.country.getSave().getGame()),
                                                                 OsaSaveEditorUtils.localize(this.country.getSave().getGame().getInstitution(i).getName(),
                                                                                             this.country.getSave().getGame()),
                ...
                this.country.getEstates()
                            .stream()
                            .sorted(Comparator.comparing(e -> OsaSaveEditorUtils.localize(e.getEstateGame().getName(), this.country.getSave().getGame()),
                                                         Eu4Utils.COLLATOR))
                            .forEach(estate -> {
