...
import fr.osallek.osasaveeditor.common.WriteSaveTask;
...
import fr.osallek.osasaveeditor.controller.converter.ProvinceCountryCallBack;
import fr.osallek.osasaveeditor.controller.converter.ProvinceCountryStringConverter;
...
import fr.osallek.osasaveeditor.controller.converter.SuggestionProvider;
...
import fr.osallek.osasaveeditor.controller.mapview.CountriesMapView;
import fr.osallek.osasaveeditor.controller.mapview.MapViewContainer;
import fr.osallek.osasaveeditor.controller.mapview.MapViewType;
import fr.osallek.osasaveeditor.controller.pane.ZoomableScrollPane;
...
public class EditorController {
    ...
    public void initialize() {
        ...
        Config.getGameFolder().map(OsaSaveEditorUtils::getSaveFolder).map(Path::toFile).ifPresent(this.saveFileChooser::setInitialDirectory);
